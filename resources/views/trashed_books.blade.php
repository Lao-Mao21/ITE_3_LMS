<x-layouts.app :title="__('Recycle Bin - Books')">
    <script src="https://kit.fontawesome.com/9d6a4b8185.js" crossorigin="anonymous"></script>

    {{-- content books --}}
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Trashed Books</h1>
            <div class="space-x-2">
                        ...
                        @forelse($books as $book)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-sm space-x-2">
                                    ...
                                    <form action="{{ route('books.force-delete', $book->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
                                                class="text-red-600 hover:text-red-700 transition-colors"
                                                onclick="return confirm('Permanently delete this book? This action cannot be undone.')">
                                            Delete Permanently
                                        </button>
                                    </form>
                                </td>
